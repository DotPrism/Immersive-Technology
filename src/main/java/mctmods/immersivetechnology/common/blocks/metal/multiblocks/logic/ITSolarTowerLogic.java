package mctmods.immersivetechnology.common.blocks.metal.multiblocks.logic;
...
public class ITSolarTowerLogic implements IMultiblockLogic {
    @Override
    public IMultiblockState createInitialState(IInitialMultiblockContext iInitialMultiblockContext) {
        return null;
    }
    ...
    public static class State implements IMultiblockState, ProcessContext.ProcessContextInWorld
    {
        @Override
